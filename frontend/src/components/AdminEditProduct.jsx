        ...
        <div className='fixed w-full h-full bg-slate-200 bg-opacity-50 top-0 left-0 right-0 bottom-0 flex justify-center items-center'>
            <div className='bg-white p-4 rounded w-full max-w-2xl h-full max-h-[80%] overflow-hidden'>
                ...
                <form className='grid p-4 gap-2 overflow-y-scroll h-full pb-5' onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="shape" className='mt-3'>Shape : </label>
                    <input
                        type="text"
                        id='shape'
                    ...
                    <div>
                        {data?.productImage[0] ? (
                            ...
                            <p className='text-red-500 text-xs'>*Upload product Image</p>
                        )}
                    </div>
                    ...
                    <button className='px-3 py-2 bg-red-600 text-white rounded mb-10 hover:bg-red-700'>Update Product</button>
                </form> 
            </div>
            {openFullScreenImage && (
